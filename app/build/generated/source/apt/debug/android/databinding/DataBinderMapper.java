...
class DataBinderMapper  {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
                case com.example.android.sunshine.R.layout.activity_forecast:
                    return com.example.android.sunshine.databinding.ActivityForecastBinding.bind(view, bindingComponent);
                case com.example.android.sunshine.R.layout.activity_detail:
 {
    ...
    int getLayoutId(String tag) {
        ...
        switch(code) {
            case 1442485175: {
                if(tag.equals("layout/activity_forecast_0")) {
                    return com.example.android.sunshine.R.layout.activity_forecast;
                }
                break;
            }
            case 597830097: {
