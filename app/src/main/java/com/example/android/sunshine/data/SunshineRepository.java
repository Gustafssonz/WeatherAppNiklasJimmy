...
public class SunshineRepository {
    ...
    private SunshineRepository(WeatherDao weatherDao,
        ...
        networkData.observeForever(newForecastsFromNetwork -> {
            // Insert our new weather-data into the SunShines database
    ...
    // TODO 2) Create a repository-method for fetching the result for the query
    // TODO 20) Change WeatherEntry to another Type or use List
