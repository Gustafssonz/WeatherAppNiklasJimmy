 ...
 */
// TODO 8 Make MainActivity into a LifeCycleActivity
public class MainActivity extends LifecycleActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO 9) Setup Factory together with ViewModel
        MainActivityModelFactory factory = InjectorUtils.provideMainActivityViewModelFactory(this.getApplicationContext());
        mViewModel = ViewModelProviders.of(this, factory).get(MainActivityViewModel.class);

        // TODO 10) Observe the viewmodel and set the recycleview into position 0
