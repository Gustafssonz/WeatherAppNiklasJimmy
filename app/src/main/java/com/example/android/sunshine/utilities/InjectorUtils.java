...
import com.example.android.sunshine.ui.list.MainActivityModelFactory;
...
public class InjectorUtils {
    ...
    // TODO 7) Create the Injector for Factory.
    public static MainActivityModelFactory provideMainActivityViewModelFactory(Context context) {
        SunshineRepository repository = provideRepository(context.getApplicationContext());
        return new MainActivityModelFactory(repository);
    }
